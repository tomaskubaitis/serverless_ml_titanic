...
def g():
    ...
    passenger_url = "https://raw.githubusercontent.com/tomaskubaitis/serverless_ml_titanic/assets/" + passenger_str + ".png"
    ...
    if label == 1:
        ...
        label_str = "victim"
    label_url = "https://raw.githubusercontent.com/tomaskubaitis/serverless_ml_titanic/assets/" + label_str + ".png"
    if label == 1:
